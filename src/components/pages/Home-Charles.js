...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div>
          Usuarias: <input name="usuaria_empesa" type="radio" onClick={() => { this.changeForm(true) }} />
          <br/>
          Empresas: <input name="usuaria_empesa" type="radio" onClick={() => { this.changeForm(false) }} />
        </div>
        {
          this.state.usuarias ? <Usuarias /> : <Empresas />
        }
