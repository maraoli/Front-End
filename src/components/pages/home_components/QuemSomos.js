        ...
        return (
            <section id="services">
                ...
                <div class="row">
                    ...
                    <h3 class="section-subheading text-muted">Tudo começou através do curso Code[XP] do Senai-SP em um hackathon em que nos conhecemos e tivemos a grande sorte
                        de sair com o Tema Empoderamento Feminino na área da Tecnologia proposto pela Microsoft. Logo percebemos que
                    ...
                    <h3 class="section-subheading text-muted">O getProgramadora(); é uma rede voltada para as mulheres na tecnologia. Atualmente, focamos em agregar valor e
